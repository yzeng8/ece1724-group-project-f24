...
object distributedPRtwitter { // Updated object name
  def main(args: Array[String]): Unit = {
    if (args.length < 2) {
      System.err.println("Usage: distributedPRtwitter <input_file> <num_iterations>")
      System.exit(1)
    }
    ...
    val spark = SparkSession.builder
      ...
      .master("spark://10.188.0.2:7077") // Use Spark master URL
      .getOrCreate()
    ...
    ranks.sortBy(_._2, ascending = false)
      ...
      .saveAsTextFile("output/pagerank_results")
